...
- [**tool_search**](/en/studio/api-reference/built-in-tools/tool-search) - Search for tools in current scope
...
- [**subtask_run**](/en/studio/api-reference/built-in-tools/subtask-run) - Spawn subtask with isolated context
...
- [**resource_read**](/en/studio/api-reference/built-in-tools/resource-read) - Read documentation/guidelines from current scope
- [**prompt_read**](/en/studio/api-reference/built-in-tools/prompt-read) - Read prompt templates from current scope
