...
- **Agent** — which [Virtual MCP](/en/studio/virtual-mcps) (agent) to run
...
**Automations vs Decopilot**: [Decopilot](/en/studio/decopilot/overview) is interactive — a human converses with the agent and approves actions. Automations are fire-and-forget: the agent runs, completes its task, and the result appears in [Monitoring](/en/studio/monitoring).
...
3. Choose an [agent](/en/studio/agents) — the Virtual MCP that will execute
...
- Each run creates a thread visible in [Monitoring](/en/studio/monitoring)
...
**Next steps**: Learn about [Agents](/en/studio/agents) to understand how to design the Virtual MCPs that automations execute, or explore [Monitoring](/en/studio/monitoring) to track automation runs.
