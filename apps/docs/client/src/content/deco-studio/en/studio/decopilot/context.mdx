...
Decopilot automatically balances what goes into your context window: instructions from your current [scope](/en/studio/decopilot/overview#scopes), available [tools](/en/studio/concepts#tools), conversation history, and more. Larger context windows mean you can accomplish more complex work in a single session before needing to refresh.
...
4. **Enabled tools** - Additional [tools](/en/studio/concepts#tools) you've activated during your session
...
Using subtasks for specific work keeps your main context clean. Subtasks run in their own isolated context space, then return only a summary of results to your main conversation. You can optionally spawn [agents](/en/studio/agents)—specialists in specific fields—into subtasks to bring domain expertise to the isolated work.
...
See [Agents](/en/studio/agents) for more on how agents provide fresh, focused context for specific tasks.
...
**Next steps**: Learn about [Scopes](/en/studio/decopilot/overview#scopes) to understand how context changes at different levels, or explore [Agents](/en/studio/agents) to see how fresh context isolation works in practice.
