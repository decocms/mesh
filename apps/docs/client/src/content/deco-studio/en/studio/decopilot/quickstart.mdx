...
- **Access to a deco Studio organization** with at least one project
...
If you haven't set up integrations yet, see [Connections](/en/studio/connections).
...
Learn more: [Tasks & Subtasks](/en/studio/decopilot/tasks-and-spawning)
...
Learn more: [Agents](/en/studio/agents)
...
Learn more: [Context Management](/en/studio/decopilot/context)
...
Learn more: [Scopes](/en/studio/decopilot/scopes)
...
**Next steps:**
- [Tools](/en/studio/decopilot/tools) - See what decopilot can do
- [Tasks](/en/studio/decopilot/tasks-and-spawning) - Deep dive into subtasks
- [Context](/en/studio/decopilot/context) - Optimize your workflow
- [Agents](/en/studio/agents) - Learn about specialists
- [Architecture](/en/studio/decopilot/architecture) - Technical details

---

Ready to dive in? Open decopilot in your deco Studio organization and start with a simple request. The agentic harness will guide you from there.
