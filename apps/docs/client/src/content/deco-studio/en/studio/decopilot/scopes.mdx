...
Scopes are largely isolated—when you select an agent, you primarily access that agent's specific tools and resources. Subtasks inherit a base prompt from the parent context, with agent-specific instructions layered on top.

## Scope and Subtasks

[Subtasks](/en/studio/decopilot/tasks-and-spawning) can run in different scopes than your main task—this enables agent collaboration.
...
- **Each scope has its own tools and resources**, with subtasks inheriting base context
...
**Next steps**: Explore [Tools](/en/studio/decopilot/tools) to see what decopilot can do, or check out [Tasks](/en/studio/decopilot/tasks-and-spawning) to understand task organization.
