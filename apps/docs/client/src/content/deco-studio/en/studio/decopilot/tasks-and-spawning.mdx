...
Tasks are accessible throughout deco Studio:
...
You can see all tasks requiring attention by clicking the **tasks icon** in the deco Studio sidebar. This view shows tasks grouped by status—letting you quickly identify which tasks need your input.
...
A **subtask** is a separate conversation that branches off from your main task to handle focused work. The key difference: subtasks start with fresh [context](/en/studio/decopilot/context)—they don't inherit your accumulated conversation history.
...
Subtasks can run in different [agent](/en/studio/agents) scopes than your main task—this is how specialized agents collaborate.
...
Subtasks are powerful for managing your [context window](/en/studio/decopilot/context):
...
**Next steps**: Learn about [Context](/en/studio/decopilot/context) to understand how tasks manage your working memory, explore [Tools](/en/studio/decopilot/tools) to see what decopilot can do, or check out [Agents](/en/studio/agents) for specialized scopes you can use with subtasks.
