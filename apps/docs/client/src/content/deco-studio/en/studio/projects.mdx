...
**Projects** are organizational units that leverage [Virtual MCPs](/en/studio/virtual-mcps) to manage tools, resources, and prompts within a specific work context. Use projects to isolate capabilities by product, client, team, or initiative.
...
4. **Tools** - Actions agents may take on this project (select from [connections](/en/studio/connections) or create inline)
...
Since projects are [Virtual MCPs](/en/studio/virtual-mcps), you get full composability—remix external capabilities with custom definitions to build exactly what your team needs.
...
**Next steps**: Learn about [Virtual MCPs](/en/studio/virtual-mcps) to understand how projects aggregate capabilities, or see [Authorization and Roles](/en/studio/user-management) for access control.
