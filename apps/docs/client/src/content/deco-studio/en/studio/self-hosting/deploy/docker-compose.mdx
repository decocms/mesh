...
This guide covers deploying the deco Studio locally using Docker Compose for quick testing and development.

Learn more: [the deco Studio website](https://www.decocms.com)
...
<Callout type="tip">
  These configurations are all you need to start testing with deco Studio. If you need other options, check the sections below.
</Callout>
...
The deco Studio application loads this file on startup to configure:
