...
Este guia cobre o deploy do deco Studio localmente usando Docker Compose para testes rápidos e desenvolvimento.
...
<Callout type="tip">
  Essas configurações são tudo que você precisa para começar a testar com o deco Studio. Se precisar de outras opções, confira as seções abaixo.
</Callout>
...
A aplicação deco Studio carrega este arquivo na inicialização para configurar:
