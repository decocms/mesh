---
title: Introduction
description: Developer docs for decocms and the deco CMS platform
icon: Rocket
---
...
## Learn decocms (concepts + product surfaces)

- **[decocms Overview](/en/mcp-mesh/overview)**
- **[Quickstart](/en/mcp-mesh/quickstart)**
- **[Concepts](/en/mcp-mesh/concepts)**
- **[Connections](/en/mcp-mesh/connections)**
- **[Virtual MCPs](/en/mcp-mesh/virtual-mcps)**
...
<Callout type="warning">
  **Docs split (quick guide):**
  ...
  - **decocms** → Self-hosting, deploying, and operating decocms (recommended).
...
## Platform structure: Core → Apps & Store
