...
| `options` | `object` | Optional | Options for the question (type, choices, etc.) |

## Options Object

| Field | Type | Description |
|-------|------|-------------|
| `type` | `"text" \| "choice" \| "confirm"` | Type of input expected |
| `choices` | `string[]` | Available choices (for `type: "choice"`) |
