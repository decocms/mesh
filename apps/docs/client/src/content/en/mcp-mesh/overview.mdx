...
- **Store**: browse a catalog of Integrations you can connect to (default: the official MCP Registry).
- **Integrations**: connect and manage MCP servers (HTTP MCP endpoints).
- **Assistants**: publish a curated "virtual MCP server" that aggregates tools/resources/prompts from multiple connections.
