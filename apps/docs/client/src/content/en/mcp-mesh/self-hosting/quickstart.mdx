---
title: Quickstart
description: Run Mesh locally or deploy to your infrastructure
icon: Rocket
---
...
**More details:** [Local: Docker Compose](/en/mcp-mesh/self-hosting/deploy/docker-compose)
...
**More details:** [Kubernetes: Helm Chart](/en/mcp-mesh/self-hosting/deploy/kubernetes)

## 2) Create a Connection

When you open a new organization, deco CMS will prompt you to:
