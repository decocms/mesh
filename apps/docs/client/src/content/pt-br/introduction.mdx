---
title: Introdução
description: Documentação de desenvolvimento do decocms e da plataforma deco CMS
icon: Rocket
---
...
- **decocms**: [decocms.com/mesh](https://www.decocms.com/mesh)
...
## Aprenda decocms (conceitos + superfícies do produto)

- **[Visão geral](/pt-br/mcp-mesh/overview)**
- **[Quickstart](/pt-br/mcp-mesh/quickstart)**
- **[Conceitos](/pt-br/mcp-mesh/concepts)**
- **[Conexões](/pt-br/mcp-mesh/connections)**
- **[Virtual MCPs](/pt-br/mcp-mesh/virtual-mcps)**
...
<Callout type="warning">
  **Divisão da documentação (guia rápido):**
  ...
  - **decocms** → Auto-hospedagem, deploy e operação do decocms (recomendado).
...
## Estrutura da plataforma: Core → Apps & Store
