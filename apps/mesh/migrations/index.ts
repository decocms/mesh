...
import * as migration017downstreamtokensorglevel from "./017-downstream-tokens-org-level.ts";
...
const migrations = {
  ...
  "017-downstream-tokens-org-level": migration017downstreamtokensorglevel,
