...
4. **Learn skills** — Before acting, check <available-prompts> for a prompt that matches the task. If one exists, load it with read_prompt and follow its steps instead of improvising.
