...
import { PublishRequestStorage } from "@/storage/registry/publish-request";
import { PublishApiKeyStorage } from "@/storage/registry/publish-api-key";
import { PublicPublishRequestInputSchema } from "@/tools/registry/schema";
...
async function publishRequestCreatedEvent(args: {
  ...
  // On some configurations, this may not be supported and is safely ignored.
  try {
