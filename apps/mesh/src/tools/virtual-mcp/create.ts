 ...
 *
 * Create a new Virtual MCP (organization-scoped) with collection binding compliance.
 */
...
export const COLLECTION_VIRTUAL_MCP_CREATE = defineTool({
  ...
  description: "Create a new Virtual MCP in the organization",
...
/** @deprecated Use COLLECTION_VIRTUAL_MCP_CREATE instead */
export const COLLECTION_GATEWAY_CREATE = COLLECTION_VIRTUAL_MCP_CREATE;
