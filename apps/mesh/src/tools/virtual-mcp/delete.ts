...
export const COLLECTION_VIRTUAL_MCP_DELETE = defineTool({
  ...
  description: "Delete a Virtual MCP",
...
/** @deprecated Use COLLECTION_VIRTUAL_MCP_DELETE instead */
export const COLLECTION_GATEWAY_DELETE = COLLECTION_VIRTUAL_MCP_DELETE;
