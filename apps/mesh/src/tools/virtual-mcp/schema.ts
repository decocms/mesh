 ...
 * Virtual MCPs aggregate tools, resources, and prompts from multiple connections.
...
// Re-export with Gateway aliases for backward compatibility
export {
  VirtualMCPEntitySchema as GatewayEntitySchema,
  VirtualMCPCreateDataSchema as GatewayCreateDataSchema,
  VirtualMCPUpdateDataSchema as GatewayUpdateDataSchema,
  VirtualMCPConnectionSchema as GatewayConnectionSchema,
};
export type { VirtualMCPEntity as GatewayEntity };
export type { VirtualMCPCreateData as GatewayCreateData };
export type { VirtualMCPUpdateData as GatewayUpdateData };
export type { VirtualMCPConnection as GatewayConnection };
