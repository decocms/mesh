...
export const COLLECTION_VIRTUAL_MCP_UPDATE = defineTool({
  ...
  description: "Update a Virtual MCP",
...
/** @deprecated Use COLLECTION_VIRTUAL_MCP_UPDATE instead */
export const COLLECTION_GATEWAY_UPDATE = COLLECTION_VIRTUAL_MCP_UPDATE;
