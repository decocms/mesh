 ...
 * to the user via `user-data-share` (see
 * packages/sandbox/image/skills/user-data/share.py). Files live under
 ...
 *
 * v1.5 attribution: outputs are aggregated under the *last* assistant
