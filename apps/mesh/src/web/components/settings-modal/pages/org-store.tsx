...
function OrgStoreContent() {
  ...
  // Separate registries into categories
  ...
  // Private registries = everything except well-known ones and self MCP
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Configure which registries appear in the store and manage private
          registries.
        </p>
      </div>
