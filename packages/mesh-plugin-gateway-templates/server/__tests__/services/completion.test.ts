...
function createTestTemplate(
  overrides?: Partial<GatewayTemplateEntity>,
): GatewayTemplateEntity {
  return {
    id: "gtpl_test",
    organization_id: "org_test",
...
// Create mock storage
function createMockStorage(): GatewayTemplatesStorage {
  return {
    templates: {
      findById: async () => null,
      list: async () => [],
...
describe("completeSession", () => {
  ...
  it("builds redirect URL with query params", async () => {
    ...
    expect(result.redirectUrl).toContain("sessionId=gtsess_test");
