/**
 * Gateway Templates Plugin - Server Entry Point
 *
...
import { createStorage, type GatewayTemplatesStorage } from "./storage";
...
export const serverPlugin: ServerPlugin = {
  ...
  createStorage: (ctx) => {
    ...
    setPluginStorage(storage as GatewayTemplatesStorage);
    return storage;
  },
};
