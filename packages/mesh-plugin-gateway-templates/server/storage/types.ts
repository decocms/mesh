/**
 * Gateway Templates Plugin - Storage Types
 *
...
export interface GatewayTemplateTable {
  id: string;
...
export interface GatewayTemplateSessionTable {
  id: string;
  template_id: string;
  organization_id: string;
 ...
 */
export interface GatewayTemplateEntity {
  id: string;
  organization_id: string;
  title: string;
  description: string | null;
...
/**
 * Gateway Template Session entity
 */
export interface GatewayTemplateSessionEntity {
  id: string;
  template_id: string;
  organization_id: string;
...
export interface GatewayTemplateCreateInput {
  organization_id: string;
  title: string;
  description?: string | null;
  icon?: string | null;
...
export interface GatewayTemplateUpdateInput {
  title?: string;
  description?: string | null;
  icon?: string | null;
  required_apps?: RequiredApp[];
...
export interface GatewayTemplateSessionCreateInput {
  template_id: string;
  organization_id: string;
  external_user_id: string;
  redirect_url?: string | null;
...
export interface GatewayTemplateSessionUpdateInput {
  status?: "pending" | "in_progress" | "completed";
  app_statuses?: Record<string, AppStatus>;
  created_agent_id?: string | null;
}
...
export interface GatewayTemplatesDatabase {
  gateway_templates: GatewayTemplateTable;
  gateway_template_sessions: GatewayTemplateSessionTable;
}
