/**
 * Gateway Templates Plugin - Tool Schemas
 *
...
export const GatewayTemplateEntitySchema = z.object({
  id: z.string(),
...
export const GatewayTemplateSessionEntitySchema = z.object({
  id: z.string(),
...
// CREATE
export const GatewayTemplateCreateInputSchema = z.object({
...
// UPDATE
export const GatewayTemplateUpdateInputSchema = z.object({
...
// GET
export const GatewayTemplateGetInputSchema = z.object({
  id: z.string().describe("Template ID"),
});

// LIST
export const GatewayTemplateListInputSchema = z.object({});

// DELETE
export const GatewayTemplateDeleteInputSchema = z.object({
  id: z.string().describe("Template ID to delete"),
});

// CREATE SESSION
export const GatewayTemplateCreateSessionInputSchema = z.object({
...
export const GatewayTemplateCreateSessionOutputSchema = z.object({
...
// LIST SESSIONS
export const GatewayTemplateListSessionsInputSchema = z.object({
  templateId: z.string().optional().describe("Filter by template ID"),
});

export const GatewayTemplateListSessionsOutputSchema = z.object({
  sessions: z.array(GatewayTemplateSessionEntitySchema),
});

// LIST USER AGENTS
export const GatewayTemplateListUserAgentsInputSchema = z.object({
...
export const GatewayTemplateListUserAgentsOutputSchema = z.object({
