...
type NavItem = {
  ...
  tab: "items" | "requests" | "settings" | "test";
};
...
export default function RegistryLayout() {
  ...
  }, [acceptPublishRequests, activeTab]);
  ...
  const navItems: NavItem[] = [
    ...
    { id: "test", label: "MCP Tests", icon: Tool02, tab: "test" },
  ];
    ...
    <div className="h-full flex flex-col bg-background overflow-hidden">
      <header className="shrink-0 w-full border-b border-border h-12 overflow-x-auto flex items-center justify-between gap-3 px-4 min-w-max">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <HeaderTabs activeTab={activeTab} onChange={goTo} items={navItems} />
        </div>
