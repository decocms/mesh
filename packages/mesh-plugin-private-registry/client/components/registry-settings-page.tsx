...
export default function RegistrySettingsPage({
  ...
  useEffect(() => {
    setAcceptPublishRequestsDraft(acceptPublishRequests);
  }, [acceptPublishRequests]);
  ...
  const isDirty =
    ...
    acceptPublishRequestsDraft !== acceptPublishRequests;
        ...
        <div className="grid gap-4 min-w-0 content-start">
          ...
          <Card className="min-w-0 p-4 grid gap-3 content-start">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Allow external users to submit MCP servers for approval.
              </p>
            </div>
            <div className="flex items-center justify-between rounded-lg border border-border px-3 py-2">
              <div className="grid gap-0.5">
                <Label htmlFor="accept-publish-requests" className="text-sm">
                  Accept publish requests
                </Label>
                <p className="text-xs text-muted-foreground">
                  Enables a public endpoint to collect pending MCP submissions.
                </p>
              </div>
              <Switch
