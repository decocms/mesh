 ...
 * tags, and categories. Returns only: id, title, short_description,
 * tags, categories, is_public, and icon.
 */
export const COLLECTION_REGISTRY_APP_SEARCH: ServerPluginToolDefinition = {
  name: "COLLECTION_REGISTRY_APP_SEARCH",
  description:
    "Search registry items returning minimal data (id, title, short_description, tags, categories, is_public, icon). " +
