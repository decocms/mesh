...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "ring-sidebar-ring hidden shrink-0 items-center rounded-md px-1 py-1 text-xs font-medium text-sidebar-foreground/70 outline-hidden focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
        className,
      )}
      {...props}
    />
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-xl py-0 pr-0.5 pl-1.5 text-left text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding] focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:text-sidebar-accent-foreground data-[active=true]:ring-2 data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 [&_svg]:opacity-60 hover:[&_svg]:opacity-100",
  {
    variants: {
      ...
      size: {
        default:
          "w-full! aspect-square! h-auto! p-0! justify-center text-sm border border-sidebar-border",
        sm: "h-7 text-xs",
        lg: "h-12 text-sm p-0!",
      },
    },
